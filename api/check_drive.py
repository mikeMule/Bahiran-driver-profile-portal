#!/usr/bin/env python3
"""
Google Drive diagnostic for MotoReg / GebetaDev Team - [MICHAEL].
Run from project root: python -m api.check_drive
Checks credentials, Shared Drives, and optional upload test.
"""
import os
import sys
...
CREDS_FILE = os.environ.get(
    ...
    str(_PROJECT_ROOT / "service-account-drive.json"),
)
